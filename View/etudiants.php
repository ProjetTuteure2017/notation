    ...
    ?>
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <form method="post" action="index.php?page=etudiant" enctype="multipart/form-data" id="fileLoader" style="margin-top: 10px;">
                ...
                <i class="fas fa-cloud-upload-alt"></i> Importer un fichier
                </label>
                <input type="file" id="file-upload" name="import"/>
                <input type="submit" name="submit" value="Charger" class="btn btn-primary" />
            </form>
        </div>
